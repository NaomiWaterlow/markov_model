...
output2 <- msm(formula = num_state~timestep,
              ...
              constraint = list(
                              ...
                              "timeperiod[150,180)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                               "timeperiod[180,210)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[210,240)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[240,270)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[270,Inf)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1)
              ),
              pci = pci_splits,
             lower = lower_limits,
              upper = upper_limits, 
