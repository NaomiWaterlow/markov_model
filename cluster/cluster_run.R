...
load("main_db_together_april.Rdata")
...
lower_limits <- -Inf
upper_limits <- c(Inf, Inf, Inf, 0, rep(Inf,30))

#run the model
output2 <- msm(formula = num_state~timestep,
              subject = factor_id, 
              data = main_db,
              qmatrix = Q_matrix,
               obstype = 1, 
              ...
              constraint = list(
                                ...
                                "timeperiod[30,45)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                                "timeperiod[45,60)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                                "timeperiod[60,75)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                                "timeperiod[75,90)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                              "timeperiod[90,105)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                               "timeperiod[105,120)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[120,135)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[135,150)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[150,165)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[180,195)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[195,210)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[210,225)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[225,240)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[240,255)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[255,270)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1),
                             "timeperiod[270,285)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1), 
                             "timeperiod[280,Inf)" = c(1,2,3,2,4,2,2,1,5,3,5,5,1,4,3,1)
